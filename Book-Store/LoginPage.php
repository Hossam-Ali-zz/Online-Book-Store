...
<div id="templatemo_container">
	...
	<tr>
        <td><b>Email</b></td> <td><input type = "text" name ="email" id="email" required >  </td>
        </tr>
		<tr>
        <td><b>Password</b></td> <td><input type = "password" name = "passwd" id = "passwd" required></td>
        </tr>
		</div>
		</table>
		<p align="center">
        <input type="submit" value ="Submit" name = "sub" id="sub" style="margin-left:auto;margin-right:auto;" >
		</p>
	</form>
